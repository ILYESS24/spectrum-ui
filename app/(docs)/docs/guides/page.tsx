...
export const metadata: Metadata = baseMetadata({
  ...
  description: "Learn how to build modern React applications with Aurion UI. Step-by-step tutorials, best practices, and real-world examples.",
  keywords: [
    "React tutorials",
    "UI component guide",
    "Next.js tutorials",
...
export default function GuidesPage() {
  const guides = [
    {
      title: "Getting Started with Aurion UI",
      description: "Learn how to set up Aurion UI in your React or Next.js project in under 5 minutes.",
      icon: Zap,
    ...
    },
    {
      ...
      description: "Create a fully functional admin dashboard using Aurion UI components. Includes data tables, charts, and forms.",
      icon: Code2,
    ...
    },
    {
      ...
      description: "Master the art of customizing Aurion UI components to match your brand and design system.",
      icon: Sparkles,
      ...
      <div className="mx-auto w-full min-w-0">
        <div className="space-y-2 mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Comprehensive guides to help you master React UI development with Aurion UI.
        ...
        <section className="my-12 space-y-8">
          <div>
            <h2 className="text-2xl font-bold mb-4">
              Why Choose Aurion UI for Your React Projects?
            </h2>
            <p className="text-muted-foreground mb-4">
              Aurion UI is a comprehensive React component library designed for modern web applications.
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span>How to integrate Aurion UI components into your React or Next.js applications</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary">•</span>
          ...
          <div className="rounded-lg border p-6 bg-muted/50">
            ...
            <p className="text-sm text-muted-foreground mb-4">
              These tutorials are most popular among developers learning to use Aurion UI:
            </p>
