...
const testimonials = [
  {
    quote:
      "Aurion UI is a game-changer! Its components are so well-designed and customizable that it made our app look polished and professional in no time.",
    name: "Ananya Gupta",
  ...
  {
    quote:
      "I love the simplicity and minimalism of Aurion UI. The components are intuitive and fit seamlessly into our existing projects.",
    name: "Sophia Allen",
  ...
  {
    quote:
      "As a junior developer, Aurion UI has been a lifesaver. The documentation is straightforward, and the components work flawlessly with Tailwind CSS.",
  ...
  {
    quote:
      "The integration with Shadcn made it super easy to customize the components. Aurion UI is now a must-have in our tech stack.",
    name: "Priya Sharma",
