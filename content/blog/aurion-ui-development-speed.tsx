...
const blogPost = {
  title: 'How Aurion UI Accelerates Development Speed and Design Consistency',
  excerpt:
    'Ever feel like you spend too much time building the same buttons and forms over and over? Aurion UI helps you build faster without sacrificing quality. Here\'s how it works.',
  author: {
    name: 'Arihant Jain',
    role: 'Engineering',
    avatar: '/arihant.jpeg',
  ...
  content: (
    <div className="space-y-6">
      ...
      <p className="text-base font-normal dark:text-[#ededed] text-[#0A0A0A]">
        ...
        Most teams end up choosing one or the other. Aurion UI lets you have both.
      </p>
      ...
      <p className="text-base font-normal dark:text-[#ededed] text-[#0A0A0A]">
        ...
        Aurion UI gives you all these components ready to go. No more starting from scratch every time. 
      ...
      <p className="text-base font-normal dark:text-[#ededed] text-[#0A0A0A]">
        Aurion UI uses shadcn/ui and Radix UI under the hood. This means you get all the good stuff:
      </p>
  ...
  return (
    ...
    >
      ...
      <p className="text-base font-normal dark:text-[#ededed] text-[#0A0A0A]">
        ...
        Aurion UI fixes this by giving everyone the same components to work with. 
      ...
      <p className="text-base font-normal dark:text-[#ededed] text-[#0A0A0A]">
        ...
        With Aurion UI, you&apos;re done in minutes:
      </p>
...
export function Dashboard() {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      ...
      <p className="text-base font-normal dark:text-[#ededed] text-[#0A0A0A]">
        The best code is the code you don&apos;t have to write. Aurion UI handles the boring stuff 
